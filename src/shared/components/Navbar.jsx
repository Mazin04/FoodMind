...
function Navbar() {
    ...
    return (
        <div className="w-full h-full min-w-[60px] sm:min-w-[90px] py-4 sm:p-2 flex flex-col items-center justify-between xl:items-end space-y-4 text-md text-neutral-900 dark:text-white bg-blue-100 dark:bg-neutral-900 border-r-1 border-neutral-700">
            <div>
                ...
                <div className='flex flex-col items-center xl:items-end justify-center space-y-4'>
                    {/* Home button */}
                    <button
                        className={`dark:bg-neutral-900 dark:hover:bg-neutral-800 hover:bg-blue-300 py-2 sm:p-5 rounded-full flex justify-center items-center cursor-pointer ${location.pathname === URLS.HOME ? "font-bold" : ""}`}
                        id='home'
                    ...
                    {/* Profile button */}
                    <button
                        className={`dark:bg-neutral-900 dark:hover:bg-neutral-800 hover:bg-blue-300 py-2 sm:p-5 rounded-full flex justify-center items-center cursor-pointer ${location.pathname === URLS.PROFILE ? "font-bold" : ""}`}
                        id='profile'
                    ...
                    {/* Pantry button */}
                    <button
                        className={`dark:bg-neutral-900 dark:hover:bg-neutral-800 hover:bg-blue-300 py-2 sm:p-5 rounded-full flex justify-center items-center cursor-pointer ${location.pathname === URLS.PANTRY ? "font-bold" : ""}`}
                        id='profile'
                    ...
                    {/* Recipes button */}
                    <button
                        className={`dark:bg-neutral-900 dark:hover:bg-neutral-800 hover:bg-blue-300 py-2 sm:p-5 rounded-full flex justify-center items-center cursor-pointer ${location.pathname === URLS.CREATE_RECIPE ? "font-bold" : ""}`}
                        id='settings'
                    ...
                    {/* Settings button */}
                    <button
                        className={`dark:bg-neutral-900 dark:hover:bg-neutral-800 hover:bg-blue-300 py-2 sm:p-5 rounded-full flex justify-center items-center cursor-pointer ${location.pathname === URLS.SETTINGS ? "font-bold" : ""}`}
                        id='settings'
            ...
            <div className='mb-2'>
                <div
                    className="flex items-center justify-center xl:justify-start gap-4 sm:px-5 py-4 rounded-full bg-blue-100 dark:bg-neutral-900 dark:hover:bg-neutral-800 hover:bg-blue-300 cursor-pointer w-full xl:w-auto"
                    onClick={() => redirectTo('PROFILE')}
                >
