  ...
  return (
    <>
      <div className='dark:bg-neutral-900 bg-stone-100 min-h-screen flex flex-row justify-center items-center'>
        <div className='dark:bg-zinc-800 bg-blue-50 w-[50%] min-h-screen backdrop-blur-2xl br-3xl flex flex-col justify-center items-center relative'>
        ...
        <div className='dark:bg-neutral-900 bg-blue-100 w-[50%] min-h-screen flex flex-col justify-center items-center relative'>
          <button className='absolute dark:text-white top-7 right-55'>{t('change_login')}</button>
          <div className='absolute top-5 right-10'><LanguageSelect/></div>
          <DarkInner className='absolute bottom-5 right-5 dark:text-white text-neutral-900 text-[50px]' duration={500} onToggle={toggleMode}></DarkInner>

          <div id='form' className='flex flex-col justify-center items-center w-[40%]'>
            <h1 className='text-3xl font-bold text-center dark:text-white text-neutral-900'>{t('welcome_register')}</h1>
            <p className='text-lg text-center dark:text-white text-neutral-900 mt-3 mb-4'>{t('enter_to_create')}</p>
